...
semicolons and all manner of other things today long forgotten (let's just
forget that this is written in C# which uses semicolons for a second).
...
utterly prepossessing EDI document.
